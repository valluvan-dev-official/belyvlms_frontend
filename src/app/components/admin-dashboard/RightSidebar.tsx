import { CircleCheck, ChevronLeft, ChevronRight, User, LogOut, X } from 'lucide-react';
...
export function RightSidebar({ isOpen, onClose }: RightSidebarProps) {
  ...
  return (
    <div 
      className={`h-full bg-white border-l border-gray-200 shadow-lg transition-all duration-300 flex-shrink-0 overflow-hidden flex flex-col ${
        isOpen ? 'w-80' : 'w-0'
      }`}
    >
      <div className="flex-1 flex flex-col p-6 w-80 overflow-y-auto">
        {/* Header with Close Button */}
        <div className="flex items-center justify-between mb-2">
           <span className="font-semibold text-[#1A1D1F]">Profile</span>
        ...
        {/* Calendar */}
        <div className="bg-[#FAFAFA] rounded-2xl p-4 mt-6">
        ...
        <div className="mt-6">
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-white border border-[#E0E0E2] rounded-xl hover:border-[#4ECDC4] hover:bg-[#F7F7F8] transition-all"
          >
