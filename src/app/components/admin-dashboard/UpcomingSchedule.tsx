      ...
      <div className="space-y-2 sm:space-y-3">
        {scheduleItems.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className={`${colors.bg} ${colors.border} border rounded-xl p-3 sm:p-4 hover:shadow-md transition-all`}
            >
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={`text-xs sm:text-sm font-semibold ${colors.text} mb-1 sm:mb-2`}>
                    {item.title}
                  </h4>
                  
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <div className="flex items-center gap-1.5">
                      <Clock className={`w-3 h-3 sm:w-3.5 sm:h-3.5 ${colors.icon}`} />
                    ...
                    <div className="flex items-center gap-1.5">
                      <Users className={`w-3 h-3 sm:w-3.5 sm:h-3.5 ${colors.icon}`} />
                      <span className={`text-xs font-medium ${colors.text}`}>
