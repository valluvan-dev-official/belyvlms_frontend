export function TrainerQuickActionBar() {
  return (
    <div className="bg-gradient-to-r from-[#4ECDC4] to-[#44A08D] rounded-2xl p-4 sm:p-6 shadow-lg">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div className="text-white">
          <h3 className="text-lg sm:text-xl font-bold mb-1">Ready to Start Teaching?</h3>
          <p className="text-xs sm:text-sm opacity-90">
            View your schedule, manage batches, or access class materials
          </p>
        </div>
