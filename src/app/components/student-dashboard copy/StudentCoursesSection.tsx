import { BookOpen, Clock, CheckCircle, Star, Phone, MoreVertical, Play } from 'lucide-react';
...
export function StudentCoursesSection() {
  ...
  const stats = {
    ...
    inProgress: courses.filter((c) => c.course_status === 'IN_PROGRESS').length,
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {/* Filter Tabs */}
      <div className="bg-white rounded-full border border-[#E0E0E2] p-1.5 inline-flex gap-1">
...
function MyCourseCard({ course }: MyCourseCardProps) {
  ...
  return (
    <div 
      className="bg-white rounded-2xl shadow-sm border border-[#E0E0E2] overflow-hidden hover:shadow-lg transition-all cursor-pointer"
