  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={isLoading}
        className={`flex items-center gap-2 px-2 py-1.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 ${isOpen ? 'ring-2 ring-gray-200' : ''}`}
      >
              ...
              {availableRoles.map((role) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${isActive ? 'bg-gray-50' : 'hover:bg-gray-50'
                      }`}
                  >
